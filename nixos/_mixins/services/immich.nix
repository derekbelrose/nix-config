{ immichHost ? "gula" }:{ immichHost, config, ... }:

let
  inherit immichHost; # TODO: put your immich domain name here
	
  immichRoot = "/store/services/immich"; # TODO: Tweak these to your desired storage locations
  ...
  postgresPassword = "..."; # TODO: put a random password here
  postgresUser = "immich";
  postgresDb = "immich";
